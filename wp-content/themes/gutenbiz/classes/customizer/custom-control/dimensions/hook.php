...
if( !class_exists( 'Gutenbiz_Customizer_Dimensions_Integration' ) ){

	class Gutenbiz_Customizer_Dimensions_Integration extends Gutenbiz_Customizer{
		...
		public static $class = 'Gutenbiz_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'gutenbiz' );
	...
	new Gutenbiz_Customizer_Dimensions_Integration();
}
