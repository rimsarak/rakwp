 ...
 */
if( !class_exists( 'Gutenbiz_Customizer_Slider_Integration' ) ){
	class Gutenbiz_Customizer_Slider_Integration extends Gutenbiz_Customizer{
		...
		public static $class = 'Gutenbiz_Customizer_Slider_Control';
	...
	new Gutenbiz_Customizer_Slider_Integration();
}